...
const GAME_ID = 'pillarsofeternity'
const GAME_NAME = 'Pillars of Eternity'
const GAME_EXECUTE = 'PillarsOfEternity.exe'

const STEAMAPP_ID = '291650';
const GOGAPP_ID = '1207666813';
//const XBOX_ID = '';
//const EPICAPP_ID = '';
...
function main(context) {
  ...
  context.once(() => {
    if (context.api.ext.bepinexAddGame !== undefined) {
      ...
      //unpack BepInEx
      let archivePath = path.join(__dirname, 'assets', 'BepInEx_x86_5_4_21_0_wconfig.zip');
